    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0;">
        <div
            ...
            <form action="/register" method="POST" style="display: flex; flex-direction: column; gap: 15px;">
                ...
                <select name="role"
                    style="padding: 10px; font-size: 16px; border: 1px solid #ddd; border-radius: 4px; width: 100%; box-sizing: border-box; background-color: white; cursor: pointer; color: #333;">
                    <option value="" disabled selected style="color: #aaa;">Register As</option>
